  ...
  <v-dialog v-model="value" max-width="800" persistent>
    <v-card max-width="800" class="rounded-lg">
      <v-toolbar color="primary" dense elevation="0">
        <v-toolbar-title class="white--text font-weight-bold">Nueva promocion</v-toolbar-title>
        <v-spacer></v-spacer>
            ...
            <v-col class="col-12">
              <v-card>
                <v-card-text class="pa-2">
                  ...
                  <v-slider thumb-label="always" color="black" height="15" track-size="20" v-model="promotion.progress">
                  </v-slider>
